                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.gpt.update') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="api_host" name="api_host" value="{{ old('api_host', $setting->api_host ?? 'api.openai.com') }}">
                            @error('api_host')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="api_url" name="api_url" value="{{ old('api_url', $setting->api_url ?? 'https://api.openai.com/v1/chat/completions') }}">
                            @error('api_url')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
